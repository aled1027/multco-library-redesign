...
<div class="container">
	<details class="mb-5rem">
		...
		<a href="https://multcolib.org/events-classes">https://multcolib.org/events-classes</a>. At
		times, I've had issues navigating the events at the library, and some pages on the library
		website load slowly, are not aesthetically pleasing, and struggle with some lighthouse metrics,
		so this is me exploring ways to address those issues. This tool aims to be simple, accessible,
		and useable. Note that this is a demo; a full implementation as needed by the library would have
		additional requirements, such as internationalization and language support. (The library website
		provides this!).
	</details>
